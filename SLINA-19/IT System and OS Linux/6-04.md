...
#### Ответ:  
Docker Compose необходим, когда мы используем не один контейнер, а много. Он помогает "согласовать" работу большого количества контейнеров и избежать хаоса в них. 
Стоит отметить удобство в применении - через одну команду у нас разворачивается целый сервис, если прописать в docker-compose файл все параметры. В какой-то степени его можно назвать мини системой оркестрации контейнеров. Простота и понятность настройки и скорость сборки.  
...
#### Ответ:  
1. Около 2х минут.
2. 2.1. Добавление сервисов в конфигурационный файл 2.2. Указание зависимостей одного сервиса от другого, изменение настроек, пробрасывание портов и папок.
